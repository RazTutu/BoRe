<div class="firstPartFooter">
  ...
  <div class="footerElement2">
    <div class="col-for-social-media">
      ...
      <a href="#" class="google button"><i class="fa fa-google fa-fw"> </i> </a>
    </div>
  </div>
  <div class="footerElement3">
    <div class="links-elements">
      ...
      <ul class="list-unstyled">
        <li>
          <a href="index.php"><i class="link-words"></i>Home</a>
        </li>
        <li>
          <a href="about.php"><i class="link-words"></i>About</a>
        </li>
        <li>
          <a href="contact.php"><i class="link-words"></i>Contact</a>
        </li>
        <li>
          <a href="./scholarly/index.html" target="_blank"><i class="link-words" style="cursor:pointer"></i>Scholarly HTML</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="secondPartFooter">
  <div class="footerElement-copy-right">© 2020 Copyright:BoRe</div>
</div>